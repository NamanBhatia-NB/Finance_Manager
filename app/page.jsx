...
export default function Home() {
  ...
  return (
    <div className="mt-40">
      ...
      <section ref={refs.aboutRef} id="about" className="scroll-mt-24 py-20 bg-blue-50 dark:bg-blue-950/30">
      ...
      <section ref={refs.featureRef} id="features" className="scroll-mt-24 py-20">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">Everything you need to manage your finances smarter</h2>
      ...
      <section ref={refs.worksRef} id="works" className="scroll-mt-24 py-20 bg-blue-50 dark:bg-blue-950/30">
        <div className="container mx-auto px-4">
            ...
            {testimonialsData.map((testimonial, index) => (
              <Card key={index} className="p-6">
                <CardContent className="pt-4">
                  ...
                  <div className="text-gray-600 dark:text-gray-400">{testimonial.quote}</div>
                </CardContent>
              </Card>
            ))}
          </div>
