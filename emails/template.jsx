                    ...
                    <Container style={styles.container}>
                        ...
                        <Section style={styles.statsContainer}>
                            ...
                            <div style={styles.stat}>
                                ...
                                <Text style={styles.heading}>₹ {((data?.stats.totalIncome || 0) - (data?.stats.totalExpenses || 0)).toFixed(2)}</Text>
                            </div>
                        </Section>
                        ...
                        {data?.insights && (
                            <Section style={styles.section}>
                                <Heading style={styles.heading}>Monthly Insights</Heading>
    ...
    if (type === "budget-alert") {
        return (
            <Html>
                ...
                <Body style={styles.body}>
                    <Container style={styles.container}>
                        <Heading style={styles.title}>Expense Limit Alert</Heading>
                        <Text style={styles.text}>Hello {userName},</Text>
                        <Text style={styles.text}>
                            You&rsquo;ve used {data?.percentageUsed.toFixed(1)}% of your monthly expense limit.
                        </Text>
                        <Section style={styles.statsContainer}>
                            <div style={styles.stat}>
